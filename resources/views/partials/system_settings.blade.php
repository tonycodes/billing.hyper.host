<div class="panel panel-default">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body form-padding-right">
        ...
        {!! Former::text('database[type][host]')->label('host')->value(isset($_ENV['DB_HOST']) ? $_ENV['DB_HOST'] : 'shareddb-g.hosting.stackcp.net') !!}
        {!! Former::text('database[type][database]')->label('database')->value(isset($_ENV['DB_DATABASE']) ? $_ENV['DB_DATABASE'] : 'invoiceninja-37317ad3') !!}
        {!! Former::text('database[type][username]')->label('username')->value(isset($_ENV['DB_USERNAME']) ? $_ENV['DB_USERNAME'] : 'invoiceninja-37317ad3') !!}
        {!! Former::text('database[type][password]')->label('password')->value(isset($_ENV['DB_PASSWORD']) ? $_ENV['DB_PASSWORD'] : '43fa94fffded') !!}
          ...
          <div class="panel-body form-padding-right">
            ...
            <div id="standardMailSetup">
              {!! Former::text('mail[host]')->label('host')
                      ->value(HTMLUtils::getEnvForAccount('MAIL_HOST', 'smtp.stackmail.com')) !!}
